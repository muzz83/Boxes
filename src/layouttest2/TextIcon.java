...
// This class is used to create a TextIcon which is then used in the RotatedIcon
// class constructor to rotate labels and icons. I found this class and the
// RotatedIcon class at http://tips4java.wordpress.com/2009/04/02/text-icon/.
// I use it only to create the y-axis label in the Plot class.
